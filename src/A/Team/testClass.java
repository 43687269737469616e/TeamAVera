...
//				int jackpotPayAmount, int regularWinOdds, int regularPayout){
        ...
        while(userChoice.charAt(0) != 'Q') {
            ...
            System.out.printf("Current balance: $%.2f\n",slotPlayers[currentPlayerLoaded].getMoneyBalance());
            System.out.println("*******************************************************");
                    ...
                    while(userChoice.charAt(0) != 'Q') {
                        ...
                        switch(userChoice.charAt(0)) {
                            case 'A': // play Lucky 777
                                ...
                                System.out.println("*******************************************************");
                                System.out.printf("%s balance is: $%.2f\n", lucky777.getMachineName(),lucky777.getMachineBalance());
                                ...
                                System.out.println("*******************************************************");
                                System.out.printf("%s balance is: $%.2f\n", luckyLotto.getMachineName(),luckyLotto.getMachineBalance());
                                ...
                                System.out.println("*******************************************************");
                                System.out.printf("%s balance is: $%.2f\n", purplePeopleEater.getMachineName(),purplePeopleEater.getMachineBalance());
